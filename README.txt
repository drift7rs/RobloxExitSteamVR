...
If you want to close the script at any time, run ExitRobloxSteamVRFix.bat which will close the cmd process opened by this (mind you it closes ANY open cmd process. Sorry.)
||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
WTF GET THIS OFF MY COMPUTER

To uninstall, simply delete the Roblox SteamVR Fix folder, RunRobloxSteamVRFix.vbs and ExitRobloxSteamVRFix.bat from your computer. 